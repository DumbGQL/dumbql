...
@Component({
	...
	styles: [
		`
			...
			.dt-entry__type--query {
				background: rgba(122, 162, 247, 0.2);
				color: var(--dt-primary);
			}
			.dt-entry__type--mutate {
			...
			.dt-entry__status--success {
				background: rgba(158, 206, 106, 0.2);
				color: var(--dt-success);
			}
			.dt-entry__status--error {
