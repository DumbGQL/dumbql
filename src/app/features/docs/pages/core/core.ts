...
export const GET_NOTES = gql\`query GetNotes($filter: NoteType) {
  getNotes(filter: $filter) { id title content noteType }
	...
	protected readonly tocSections: TocSection[] = [
		...
		{
			id: 'graphqlservice', title: 'GraphqlService', children: [
		...
		{
			id: 'middleware-pipeline', title: 'Middleware Pipeline', children: [
				{ id: 'built-in-middleware', title: 'Built-in Middleware' },
			],
		},
		...
		{
			id: 'configuration', title: 'Configuration', children: [
