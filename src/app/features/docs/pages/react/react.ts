...
export class DocsReact {
  ...
  protected readonly apiEntries: ApiEntry[] = [
    ...
    {
      name: 'DumbqlProvider',
      description: 'Context provider that injects client + optional cache into the React tree.',
      type: 'component',
    },
    ...
    {
      name: 'useClient()',
      description: 'Returns DumbqlClient from the nearest DumbqlProvider. Throws if missing.',
      type: 'hook',
    },
    ...
    // ── useQuery ──
    {
      name: 'useQuery(document, options?)',
      description:
        'Reactive query hook. Executes on mount. Use fetchPolicy, pollInterval, skip, onCompleted, onError to control behaviour.',
      type: 'hook',
    },
    {
      name: 'UseQueryOptions',
      description: 'Options: { variables?, pollInterval?, skip?, onCompleted?, onError?, fetchPolicy? }',
      type: 'interface',
    },
    ...
    {
      name: 'UseQueryOptions.onError',
      description: 'Callback with error string and optional errorCode.',
      type: 'property',
    },
    {
      name: 'UseQueryOptions.fetchPolicy',
      description: 'Cache-first, network-only, or no-cache.',
      type: 'property',
      default: "'cache-first'",
    },
    {
      name: 'UseQueryResult',
      description: 'Result: { data, loading, error, errorCode?, networkStatus, called, refetch, fetchMore }',
      type: 'interface',
    },
    ...
    {
      name: 'UseQueryResult.networkStatus',
      description: 'loading | ready | error | refetching | poll.',
      type: 'property',
    },
    { name: 'UseQueryResult.called', description: 'True once the query has fired at least once.', type: 'property' },
    {
      name: 'UseQueryResult.refetch',
      description: 'Re-execute the query with optional new variables.',
      type: 'property',
    },
    {
      name: 'UseQueryResult.fetchMore',
      description: 'Merge pagination helper: fetchMore(mergeFn, vars?).',
      type: 'property',
    },
    ...
    // ── useMutation ──
    {
      name: 'useMutation(document, options?)',
      description: 'Returns mutate function and reactive result. Supports optimistic cache updates via update option.',
      type: 'hook',
    },
    {
      name: 'UseMutationOptions',
      description: 'Options: { variables?, onCompleted?, onError?, update?, optimistic? }',
      type: 'interface',
    },
    ...
    {
      name: 'UseMutationOptions.onError',
      description: 'Callback with error string and optional errorCode.',
      type: 'property',
    },
    {
      name: 'UseMutationOptions.update',
      description: 'Cache write after mutation: update(cache, result).',
      type: 'property',
    },
    {
      name: 'UseMutationOptions.optimistic',
      description:
        'Optimistic update callback: (cache) => string. Called before mutation. Auto-committed on success, rolled back on error.',
      type: 'property',
    },
    {
      name: 'UseMutationResult',
      description: 'Result: { data, loading, error, errorCode?, called, mutate }',
      type: 'interface',
    },
    ...
    { name: 'UseMutationResult.called', description: 'True once mutate has been called.', type: 'property' },
    {
      ...
      description: 'Execute the mutation: mutate(vars?). Returns Promise<GraphQLResult>.',
      type: 'property',
    },
    {
      name: 'UseMutationFn',
      description: 'Mutate function signature: (variables?) => Promise<GraphQLResult<TData>>.',
      type: 'type',
    },

    // ── useSubscription ──
    {
      name: 'useSubscription(document, options?)',
      description: 'Connects to a WebSocket subscription. Fires on mount, cleans up on unmount.',
      type: 'hook',
    },
    {
      name: 'UseSubscriptionOptions',
      description:
        'Options: { variables?, wsEndpoint?, shouldSubscribe?, reconnect?, reconnectInterval?, maxReconnects?, onNext?, onError?, onComplete? }',
      type: 'interface',
    },
    { name: 'UseSubscriptionOptions.variables', description: 'Subscription variables.', type: 'property' },
    {
      name: 'UseSubscriptionOptions.wsEndpoint',
      description: 'WebSocket URL. Defaults to HTTP→WS transform of client endpoint.',
      type: 'property',
    },
    {
      name: 'UseSubscriptionOptions.shouldSubscribe',
      description: 'Conditionally enable/disable the subscription.',
      type: 'property',
      default: 'true',
    },
    {
      name: 'UseSubscriptionOptions.reconnect',
      description: 'Enable auto-reconnect with exponential backoff.',
      type: 'property',
      default: 'false',
    },
    {
      name: 'UseSubscriptionOptions.reconnectInterval',
      description: 'Base reconnect interval in ms.',
      type: 'property',
      default: '2000',
    },
    {
      name: 'UseSubscriptionOptions.maxReconnects',
    ...
    {
      name: 'UseSubscriptionOptions.onError',
      description: 'Callback with error string and optional errorCode.',
      type: 'property',
    },
    {
      name: 'UseSubscriptionOptions.onComplete',
      description: 'Callback when the subscription stream completes.',
      type: 'property',
    },
    ...
    {
      name: 'UseSubscriptionResult.loading',
      description: 'True while initial subscription is establishing.',
      type: 'property',
    },
    ...
    // ── useLiveQuery ──
    {
      name: 'useLiveQuery(document, options?)',
      description: 'Combines a one-shot query with a WebSocket subscription for real-time updates.',
      type: 'hook',
    },
    {
      name: 'UseLiveQueryOptions',
      description: 'Options: { variables?, wsEndpoint?, shouldSubscribe?, onCompleted?, onError? }',
      type: 'interface',
    },
    { name: 'UseLiveQueryOptions.variables', description: 'Query / subscription variables.', type: 'property' },
    {
      name: 'UseLiveQueryOptions.wsEndpoint',
      description: 'WebSocket URL. Defaults to HTTP→WS transform of client endpoint.',
      type: 'property',
    },
    {
      name: 'UseLiveQueryOptions.shouldSubscribe',
      description: 'Conditionally enable/disable the WS subscription.',
      type: 'property',
      default: 'true',
    },
    {
      name: 'UseLiveQueryOptions.onCompleted',
      description: 'Callback on query success or WS update.',
      type: 'property',
    },
    {
      name: 'UseLiveQueryOptions.onError',
      description: 'Callback with error string and optional errorCode.',
      type: 'property',
    },
    ...
    // ── useFragment ──
    {
      name: 'useFragment(fragment, identifier)',
      description:
        'Subscribes to a normalized cache fragment by __typename and optional id. Returns { data, complete }.',
      type: 'hook',
    },
    ...
    {
      name: 'UseFragmentResult.complete',
      description: 'True when the fragment was fully resolved from cache.',
      type: 'property',
    },

    // ── usePrefetch ──
    {
      name: 'usePrefetch(document)',
      description:
        'Fires a query ahead of navigation. Returns a prefetch(vars?) function that resolves once the query completes.',
      type: 'hook',
    },

    // ── Suspense hooks ──
    {
      name: 'useSuspenseQuery(query, options?)',
      description:
        'Suspense-powered query. Throws a promise until data is available. Returns fully resolved data (error thrown as exception).',
      type: 'hook',
    },
    {
      name: 'useBackgroundQuery(query, options?)',
      description: 'Starts fetching in a parent component. Returns a QueryRef tuple for useReadQuery.',
      type: 'hook',
    },
    {
      name: 'QueryRef',
      description: 'Object: { read(), refetch() } returned by useBackgroundQuery.',
      type: 'interface',
    },
    {
      name: 'QueryRef.read',
      description: 'Read resolved data. Throws promise if still loading or error if failed.',
      type: 'property',
    },
    {
      name: 'QueryRef.refetch',
      description: 'Re-execute the query and return a promise of GraphQLResult.',
      type: 'property',
    },
    {
      name: 'useReadQuery(queryRef)',
      description: 'Reads resolved data from a QueryRef created by useBackgroundQuery. Returns { data }.',
      type: 'hook',
    },
    ...
    {
      name: 'QueryProps',
      description: 'Props: { document, variables?, pollInterval?, skip?, children }',
      type: 'interface',
    },
    ...
    { name: 'Subscription', description: 'Render-prop component for inline subscription.', type: 'component' },
    {
      ...
      description: 'Props: { document, variables?, wsEndpoint?, shouldSubscribe?, children }',
      type: 'interface',
    },
    ...
    {
      name: 'SubscriptionProps.shouldSubscribe',
      description: 'Conditionally enable/disable.',
      type: 'property',
      default: 'true',
    },
    {
      name: 'SubscriptionProps.children',
      description: 'Render function receiving UseSubscriptionResult.',
      type: 'property',
    },
    ...
    {
      name: 'RateLimitGate',
      description: 'Wrapper that shows fallback UI when rate-limited. Runs a countdown and fires onRetry when elapsed.',
      type: 'component',
    },
    {
      name: 'RateLimitGateProps',
      description: 'Props: { isLimited, children, fallback?, retryAfter?, onRetry?, error? }',
      type: 'interface',
    },
    {
      name: 'RateLimitGateProps.isLimited',
      description: 'Whether rate limit is currently exceeded.',
      type: 'property',
    },
    { name: 'RateLimitGateProps.children', description: 'Normal UI shown when not limited.', type: 'property' },
    {
      name: 'RateLimitGateProps.fallback',
      description: 'Custom fallback UI when rate limited (default: built-in banner).',
      type: 'property',
    },
    {
      name: 'RateLimitGateProps.retryAfter',
      description: 'Countdown duration in ms (default: 5000).',
      type: 'property',
    },
    {
      name: 'RateLimitGateProps.onRetry',
      description: 'Callback fired when the countdown completes.',
      type: 'property',
    },
    {
      name: 'RateLimitGateProps.error',
      description: 'Optional error message to display in the default banner.',
      type: 'property',
    },
    ...
    {
      name: 'gql',
      description: 'Tagged template literal for parsing GraphQL documents at build/run time.',
      type: 'function',
    },
    {
      name: 'isSuccess',
      description: 'Type guard: checks if a GraphQLResult has status === "success".',
      type: 'function',
    },
    ...
    {
      name: 'GraphQLResult',
      description: 'Result type: { status, data?, error?, errorCode? } from client operations.',
      type: 'type',
    },
    {
      name: 'CacheStore',
      description: 'Normalized cache interface from @dumbql/cache. Used by DumbqlProvider and useCache.',
      type: 'type',
    },

    // ── Val ──
    {
      name: 'useVal(initialValue)',
      description:
        'React hook that returns a ReactVal<T> — a reactive value container with null-handling methods. Re-renders on mutation.',
      type: 'hook',
    },
    {
      name: 'ReactVal<T>',
      description: 'Interface: { value, set, update, nullify, isNull, isEmpty, reset, peek, tap, swap, orElse, match }',
      type: 'interface',
    },
    ...
    {
      name: 'ReactVal.update(fn)',
      description: 'Updates the value via fn(prev) => next and triggers re-render.',
      type: 'method',
    },
  ];
